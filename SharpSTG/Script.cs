...
namespace SharpSTG
{
    namespace Script
    {
        ...
        class SCRepeat : Command
        {
            ...
            public override bool Do()
            {
                if (ScriptState.check(STG.Stage.script, repeatcondition))
        ...
        class ScriptState
        {
            public static Command CreateCommand(string cmd)
            {
                ...
                if (cmdtype == null)
                    return null;
                var cmdobj = (Command)System.Activator.CreateInstance(cmdtype);
            ...
            public static bool check(ScriptState script, string condition)
            {
                switch (condition)
                {
                    case "true":
